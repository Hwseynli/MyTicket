...
namespace MyTicket.Persistence.Migrations
{
    ...
    [Migration("20241108071922_UpdateSubCategoryAndEventTable")]
    partial class UpdateSubCategoryAndEventTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyTicket.Domain.Entities.Events.Ticket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("MyTicket.Domain.Entities.Settings.Setting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("MyTicket.Domain.Entities.Users.User", b =>
                {
                    ...
                    b.HasOne("MyTicket.Domain.Entities.Favourites.WishList", "WishList")
                        .WithOne("User")
                        .HasForeignKey("MyTicket.Domain.Entities.Users.User", "WishListId")
                        .OnDelete(DeleteBehavior.Cascade);
